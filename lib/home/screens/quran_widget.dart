...
class quran_widget extends StatelessWidget {
  ...
  final List<String> surasName = const [
    "الفاتحه",
    "البقرة",
    "آل عمران",
    "النساء",
  ...
  final List<int> versesNumber = const [
    7,
    286,
    200,
    176,
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        Expanded(child: Image.asset("assets/image/quran_image.png")),
        Container(
          ...
          child: Row(
            ...
            children: [
              Text(AppLocalizations.of(context)!.numberofayat,
                  style: TextStyle(
                      fontSize: 24,
              ...
              Text(AppLocalizations.of(context)!.nameofsusra,
                  style: TextStyle(
                      fontSize: 24,
                      color: Theme.of(context).colorScheme.tertiary))
            ],
